        ...
        <div className="section">
          <div className="columns">
            <div className="column is-2">
              <h3 className="title is-spaced is-4">Categories</h3>
              <ul>
                { categories.map((category) => <li><Link to={category.node.custom_url.url}>{category.node.name}</Link></li>)}
              </ul>
            </div>
  ...
  return (
    <Layout>
      <IndexPageTemplate
        ...
        categories={data.allBigCommerceCategories.edges}
      />
    </Layout>
  );
};
